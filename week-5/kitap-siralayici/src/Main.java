...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println("*****************************************************************************************************************");
        TreeSet<PageOrderComp> pages = new TreeSet<>();
        pages.add(new PageOrderComp("Introduction to Algorithms", 1292, "Thomas H Cormen, Charles E Leiserson, Ronald L Rivest, Clifford Stein", "September", 2009));
        pages.add(new PageOrderComp("Field and Wave Electromagnetic", 720, "David Cheng", "September", 2013));
        pages.add(new PageOrderComp("Electric Circuits 8th Edition", 855, " James W. Nilsson, Susan A. Riedel", "January", 2007));
        pages.add(new PageOrderComp("Thomas' Calculus, 11th Edition", 1228 , "George B. Thomas", "January", 2004));
        pages.add(new PageOrderComp("Schaum's Outline of Linear Algebra Fourth Edition", 432 , "Seymour Lipschutz, Marc Lipson", "August", 2008));
        System.out.println("\n");
        for(Book pgs : pages){
